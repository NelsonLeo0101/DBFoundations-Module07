...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_NPitti')
	 Begin 
	  Alter Database [Assignment07DB_NPitti] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_NPitti;
	 End
	Create Database Assignment07DB_NPitti;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_NPitti;
...
-- <Put Your Code Here> --
SELECT P.ProductName, [InventoryDate] = DateName(MM, I.InventoryDate) 
+ ', ' + DateName(YY, I.InventoryDate),
...
SELECT TOP 1000000 P.ProductName, [InventoryDate] = DateName(MM, I.InventoryDate) 
+ ', ' + DateName(YY, I.InventoryDate),
[InventoryCount] = I. [Count]
FROM vProducts AS P
INNER JOIN vInventories AS I 
...
SELECT TOP 1000000 
C.CategoryName, [InventoryDate] = DateName(MM, I.InventoryDate) 
+ ', ' + DateName(YY, I.InventoryDate),
...
When InventoryCount < [PreviousMonthCount] then -1 END, 0)
...
-- <Put Your Code Here> --
CREATE FUNCTION fProductInventoriesWithPreviousMonthCountsWithKPIs (@KPIValue INT) RETURNS TABLE AS 
